...
public class EratosthenesSieve {
    ...
    public static void sieve(long number, UlamSpiralController controller) {
        ...
        List<Long> unchecked = LongStream.rangeClosed(nextUntestedNumber, number).boxed().collect(Collectors.toList());
        ...
        while (!unchecked.isEmpty()) {
            long currentPrime = unchecked.remove(0);
